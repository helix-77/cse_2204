...
// Numerical differentiation using the backward difference method
double numericalDerivativeBackward(const vector<double>& x, const vector<double>& y, size_t index, double h) {
    ...
    if (index < 1) {
        cerr << "Error: Not enough data points for backward difference." << endl;
        return 0.0;
    }
...
int main() {
    ...
    double derivative = numericalDerivativeBackward(x, y, index, h);
